...
public class ReplyController {
    ...
    @PostMapping("/new")
    public ResponseEntity<Long> postCreateReply(@RequestBody ReplyDto dto) {
        log.info("댓글 등록 {}", dto);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<String> update(@PathVariable("id") String id, @RequestBody ReplyDto replyDto) {
