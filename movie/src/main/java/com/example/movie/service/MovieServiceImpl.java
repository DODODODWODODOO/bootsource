...
public class MovieServiceImpl implements MovieService {
    ...
    public MovieDto getRow(Long mno) {
        ...
        // result[0] [Movie(mno=3, title=Movie3), MovieImage(inum=11,
        // uuid=5ca2573f-ffbd-4909-be4d-8aa74b4d9c16, imgName=img1.jpg, path=null), 3,
        // 2.0]
        ...
        // List<MovieImage>
        // movieImages = result.stream().map(en -> (MovieImage)
